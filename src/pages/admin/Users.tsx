...
import { Plus, Search, Mail, UserCircle, CheckCircle, AlertCircle, Eye, Send, Shield, Building2, Stethoscope, Users, Calendar, Download } from 'lucide-react';
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 font-mono truncate">{user.id.substring(0, 13)}...</p>
                      </div>
                    </div>
